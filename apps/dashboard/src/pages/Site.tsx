            ...
            <div className="max-w-3xl">
              ...
              >
                ...
                <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center">
                  <input
                    className="w-full rounded-xl bg-white dark:bg-white dark:bg-zinc-950/60 border border-zinc-200 dark:border-white/10 px-3 py-2 text-sm outline-none focus:border-blue-500/60 transition-colors"
                    ...
                    {customWebhooks.map(hook => {
                      ...
                      return (
                        <div key={hook.id} className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 overflow-hidden">
                          ...
                          {/* Builder Area */}
                          {isEditing && (
                            <div className="p-5 space-y-5 bg-white dark:bg-zinc-950/30">
                              ...
                              {!hasPayload ? (
                                ...
                                <>
                                  <div className="flex items-center justify-between">
                                    <div>
                                      <h5 className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Mapeamento de Campos</h5>
                                      <p className="text-xs text-zinc-600 dark:text-zinc-500">Selecione de onde na requisição recebida devemos extrair os dados importantes.</p>
                                    </div>
                                    <button
                                      onClick={() => loadCustomWebhooks()}
                                    ...
                                    {[
                                      ...
                                      <div key={field.key}>
                                        ...
                                        <select
                                          ...
                                          className="w-full rounded-md bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 px-2.5 py-2 text-xs text-zinc-800 dark:text-zinc-200 outline-none focus:border-blue-500"
                                        >
