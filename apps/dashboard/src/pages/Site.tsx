...
async function handleTrkSubmit(e) {
  ...
  var data = {};
  // Mesmos "name" que a API trata: fn/ln (ou nome completo), email, phone+ddi (ver comentário HTML do embed)
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-500">
                      Dispare eventos quando a URL contiver um trecho ou apenas na <strong className="font-medium text-zinc-700 dark:text-zinc-300">página inicial</strong>{' '}
                      (domínio raiz, sem slug). Não use “contém <code className="text-xs">/</code>” para a home — isso casa com todas as rotas.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end bg-zinc-50 dark:bg-zinc-900/30 p-5 rounded-xl border border-zinc-200 dark:border-zinc-800">
                    <div className="md:col-span-3">
                      ...
                      <select
                        id="dash-site-url-rule-match-kind"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      <div className="bg-zinc-50 dark:bg-zinc-900/30 p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 space-y-5">
                        ...
                        {/* Group Tag */}
                        <div>
                          <label htmlFor="dash-site-form-group-tag" className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-2">
                            Tag do grupo (opcional)
                          </label>
                          <input
                            id="dash-site-form-group-tag"
                            value={formGroupTag}
