  ...
  const generatedUrl = useMemo(() => {
    const row =
      normalizedSlug && links.length
        ...
        : null;
    const host = row?.host || (links[0]?.host || 'go.trajettu.com');
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-500">
          Crie um link do tipo <code className="text-xs">https://go.trajettu.com/seu-slug</code> que dispara o evento escolhido e
