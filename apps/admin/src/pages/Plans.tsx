...
export const PlansPage = () => {
    ...
    const createPlan = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert(e?.response?.data?.error || 'Erro ao criar plano');
        }
    };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-zinc-900/50 rounded-2xl border border-zinc-200 dark:border-white/10 p-5 shadow-sm">
                        <h2 className="text-sm font-semibold mb-4">Criar Novo Plano</h2>
                        <form onSubmit={createPlan} className="space-y-4">
                            ...
                            <button className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm py-2.5 rounded-xl transition-colors">
                                Salvar Plano
                            </button>
                        </form>
                    </div>
