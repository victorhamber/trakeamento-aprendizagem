        ...
        <div className="px-6 py-5 max-h-[60vh] overflow-y-auto">
          {step === 1 && (
            <div className="space-y-3">
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">Qual o objetivo principal desta campanha?</p>
              {OBJECTIVES.map((opt) => (
                <button
                  key={opt.value}
          ...
          {step === 2 && (
            <div className="space-y-4">
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Para qual página o anúncio está levando?</p>
              <input
                type="url"
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="admin-report-wizard-analysis-profile" className="block text-sm font-medium text-zinc-800 dark:text-zinc-200">
                  Tipo de relatório
                </label>
                <select
                  id="admin-report-wizard-analysis-profile"
