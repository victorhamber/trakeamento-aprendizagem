      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/40 p-5 space-y-4 relative overflow-hidden">
            ...
            <div>
              <label htmlFor="webhook-hotmart-url" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">URL do Webhook (Copie e cole na Hotmart)</label>
              <div className="flex gap-2">
                <input
                  id="webhook-hotmart-url"
                  readOnly
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/40 p-5 space-y-4">
            ...
            <div>
              <label htmlFor="webhook-kiwify-url" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">URL do Webhook (Copie e cole na Kiwify)</label>
              <div className="flex gap-2">
                <input
                  id="webhook-kiwify-url"
                  readOnly
                  className="flex-1 rounded-lg bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 px-3 py-2 text-[11px] font-mono text-zinc-600 dark:text-zinc-400 outline-none"
      ...
      <div className="space-y-4 border-t border-zinc-200 dark:border-zinc-800 pt-8">
        ...
        <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/40 p-5 space-y-4">
          <div className="grid grid-cols-1 gap-3">
            <div>
              <label htmlFor="checkout-sim-base-url" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Link base do checkout</label>
              <input
                id="checkout-sim-base-url"
                value={checkoutUrl}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              <label htmlFor="checkout-sim-email" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Email</label>
              <input
                id="checkout-sim-email"
                value={checkoutEmail}
            ...
            <div>
              <label htmlFor="checkout-sim-phone" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Telefone</label>
              <input
                id="checkout-sim-phone"
                value={checkoutPhone}
            ...
            <div>
              <label htmlFor="checkout-sim-first-name" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Nome</label>
              <input
                id="checkout-sim-first-name"
            ...
            <div>
              <label htmlFor="checkout-sim-last-name" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Sobrenome</label>
              <input
                id="checkout-sim-last-name"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              <label htmlFor="checkout-sim-external-id" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">External ID</label>
              <input
                id="checkout-sim-external-id"
            ...
            <div>
              <label htmlFor="checkout-sim-fbp" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">FBP</label>
              <input
                id="checkout-sim-fbp"
                value={checkoutFbp}
            ...
            <div>
              <label htmlFor="checkout-sim-fbc" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">FBC</label>
              <input
                id="checkout-sim-fbc"
                value={checkoutFbc}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
            <div>
              <label htmlFor="checkout-sim-utm-source" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">UTM Source</label>
              <input
                id="checkout-sim-utm-source"
            ...
            <div>
              <label htmlFor="checkout-sim-utm-medium" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">UTM Medium</label>
              <input
                id="checkout-sim-utm-medium"
            ...
            <div>
              <label htmlFor="checkout-sim-utm-campaign" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">UTM Campaign</label>
              <input
                id="checkout-sim-utm-campaign"
            ...
            <div>
              <label htmlFor="checkout-sim-utm-content" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">UTM Content</label>
              <input
                id="checkout-sim-utm-content"
            ...
            <div>
              <label htmlFor="checkout-sim-utm-term" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">UTM Term</label>
              <input
                id="checkout-sim-utm-term"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              <label htmlFor="checkout-sim-value" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Valor</label>
              <input
                id="checkout-sim-value"
                value={checkoutValue}
            ...
            <div>
              <label htmlFor="checkout-sim-currency" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Moeda</label>
              <input
                id="checkout-sim-currency"
          ...
          <div>
            <label htmlFor="checkout-sim-generated-url" className="block text-[10px] font-medium text-zinc-600 dark:text-zinc-500 mb-1.5">Link gerado</label>
            <input
              id="checkout-sim-generated-url"
              readOnly
                        ...
                        <div className="flex flex-col min-h-0 md:min-h-[min(72vh,780px)]">
                              ...
                              return (
                                <div key={mapField.field}>
                                  ...
                                  {hasPayload && availableKeys.length > 0 ? (
                                    <select
                                      id={`webhook-pick-${hook.id}-${mapField.field}`}
                          ...
                          <div className="mt-4 p-3 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/50 space-y-2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                              <div>
                                <label className="block text-[9px] text-zinc-500 mb-0.5" htmlFor={`adm-def-cur-${hook.id}`}>Moeda</label>
                                <input
                                  id={`adm-def-cur-${hook.id}`}
                              ...
                              <div>
                                <label className="block text-[9px] text-zinc-500 mb-0.5" htmlFor={`adm-def-st-${hook.id}`}>Status</label>
                                <input
                                  id={`adm-def-st-${hook.id}`}
                              ...
                              <div>
                                <label className="block text-[9px] text-zinc-500 mb-0.5" htmlFor={`adm-def-pm-${hook.id}`}>Método de pagamento</label>
                                <input
                                  id={`adm-def-pm-${hook.id}`}
                              ...
                              <div>
                                <label className="block text-[9px] text-zinc-500 mb-0.5" htmlFor={`adm-def-ph-${hook.id}`}>Telefone</label>
                                <input
                                  id={`adm-def-ph-${hook.id}`}
                              ...
                              <div>
                                <label className="block text-[9px] text-zinc-500 mb-0.5" htmlFor={`adm-def-fn-${hook.id}`}>Nome</label>
                                <input
                                  id={`adm-def-fn-${hook.id}`}
                              ...
                              <div>
                                <label className="block text-[9px] text-zinc-500 mb-0.5" htmlFor={`adm-def-ln-${hook.id}`}>Sobrenome</label>
                                <input
                                  id={`adm-def-ln-${hook.id}`}
