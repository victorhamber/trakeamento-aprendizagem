      ...
      <aside className="hidden lg:flex flex-col bg-white dark:bg-[#080a0f] border-r border-zinc-200/60 dark:border-white/5 p-5 transition-colors duration-300">
        <Link to="/accounts" className="flex items-center gap-3 px-2 mb-7 select-none">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[10px] uppercase tracking-[0.2em] text-amber-500 dark:text-amber-400 font-bold">Super Admin</div>
          </div>
        </Link>

        <nav className="space-y-1.5 flex-1">
          <div className="text-[9px] uppercase tracking-[0.2em] font-bold px-3 mb-2 text-zinc-400 dark:text-zinc-600">Gestão Geral</div>
        ...
        <div className={`pt-5 border-t ${isDark ? 'border-white/5' : 'border-zinc-200'}`}>
          <div className={`flex items-center gap-3 px-3 py-3 rounded-2xl ${isDark ? 'bg-white/[0.02] border border-white/5' : 'bg-zinc-50 border border-zinc-200'}`}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className={`text-[10px] ${isDark ? 'text-amber-500' : 'text-amber-600'} font-bold uppercase`}>SUPER ADMIN</div>
            </div>
          </div>
          <button
            onClick={() => auth.logout()}
          ...
          <div className={`absolute inset-y-0 left-0 w-72 max-w-full p-4 flex flex-col ${isDark ? 'bg-[#0b0f17] border-r border-white/10' : 'bg-white border-r border-zinc-200'}`}>
            ...
            >
              ...
              <div className="leading-tight">
                ...
                <div className="text-[10px] text-amber-500 font-bold uppercase">Super Admin</div>
              </div>
            </Link>
